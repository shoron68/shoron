        ...
        <div className=" container mx-auto  ">
            <div className="flex justify-between">
                ...
                <div className='mt-[5px]'>
                    <ul  className={`lg:flex  text-center absolute z-50 lg:static ${show ==true ? 'top-[100px] left-[0px] bg-[#2F1A39]  w-full  duration-700 ': ' duration-700 top-[100px] left-[-600px] -z-20 w-full bg-[none]'}`}>
                ...
                <div className='lg:hidden relative z-50 top-[4px]' data-aos='fade-right' onClick={()=>{setShow(!show)}}>
