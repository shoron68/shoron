                    ...
                    <div className="container mx-auto lg:px-0 px-[10px]">
                        <div className="lg:flex lg:justify-between">
                            <div className="lg:w-[50%] w-full lg:text-start text-center  lg:mt-[30px]">
                                <h1 className='text-[white] lg:text-[58px] text-[32px] font-pops font-bold' >Hi'<br /> I'm <span>Musfiqur Rahman</span></h1>
                                <h2 className='text-[white] lg:text-[58px] text-[24px] font-pops font-bold'>F{text} <Cursor /></h2>
